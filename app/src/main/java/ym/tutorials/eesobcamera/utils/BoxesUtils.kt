...
import ym.tutorials.eesobcamera.utils.Constants.CONFIDENCE_THRESHOLD
import ym.tutorials.eesobcamera.utils.Constants.IOU_THRESHOLD
...
object BoxesUtils {
    ...
    fun bestBox(
        ...
        numElements: Int,
        numChannel: Int,
        labels: List<String>) : List<Detection>? {

        val boundingBoxes = mutableListOf<Detection>()
